...
from GBM_Correlation_train import le, gbm_model,scaler,selected_features
# Step 8: Load test dataset
test_data = pd.read_csv(r"C:\Users\Chitrakshi\Downloads\test_data.csv")

# Step 9: Encode target variable if available
...
# Step 10: Extract selected features and scale
X_test = test_data[selected_features]
X_test_scaled = scaler.transform(X_test)

# Step 11: Make predictions
y_test_pred = gbm_model.predict(X_test_scaled)
y_test_proba = gbm_model.predict_proba(X_test_scaled)[:, 1]

# Step 12: Evaluate if ground truth available
