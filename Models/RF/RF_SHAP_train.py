...
selected_features = ['Age_at_diagnosis', 'IDH1', 'TP53', 'PTEN']
...
# Step 5: Train the Random Forest model on the full training data
...
# Confusion matrix-based specificity (only valid for binary classification)
